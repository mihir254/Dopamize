...
const Home = () => {
    const initialTasks = [
        {id: 1, completed: false, task: "This is test task 1"},
        {id: 2, completed: false, task: "This is test task 2"},
        {id: 3, completed: true, task: "This is test task 3"},
        {id: 4, completed: false, task: "This is test task 4"},
    ];
                            ...
                            >
                                ...
                                {tasks.map((item, index) => (
                                    // <Draggable key={item.id} draggableId={item.id.toString()} index={index}>
                                        // {(provided, snapshot) => (
                                            <li key={index}
                                                className="flex items-center p-4 m-2 border border-slate-800 rounded-lg cursor-pointer
                                                bg-[#555555] outline-2"
